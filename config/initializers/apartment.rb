...
Apartment.configure do |config|
  ...
  config.excluded_models = %w{ User UserProfile Organization UserOrganization Tenant ActiveStorage::Attachment ActiveStorage::Blob }
  ...
  #
  config.tenant_names = lambda{ Tenant.pluck(:key) }
