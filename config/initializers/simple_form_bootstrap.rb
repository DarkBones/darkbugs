...
SimpleForm.setup do |config|
  config.default_form_class = 'simple_form form-horizontal row'
  ...
  config.wrappers :vertical_form, tag: 'div', class: 'form-group col-12', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    ...
    b.use :input, class: 'form-control py-4', error_class: 'is-invalid', valid_class: 'is-valid'
    b.use :full_error, wrap_with: { tag: 'div', class: 'invalid-feedback' }
    b.use :hint, wrap_with: { tag: 'small', class: 'form-text text-muted' }
  end

  ['', 'sm', 'md', 'lg', 'xl'].each do |width|
    1.upto(12) do |col|
      ...
      config.wrappers "#{width}#{col}".to_sym, tag: 'div', class: "form-group #{class_name}", error_class: 'has-error' do |b|
        ...
        b.wrapper tag: 'div', class: "" do |wr|
          wr.use :input, class: 'form-control py-4', error_class: 'is-invalid', valid_class: 'is-valid'
